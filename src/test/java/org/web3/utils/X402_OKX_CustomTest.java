...
public class X402_OKX_CustomTest {
    ...
    public void testEIP712Sign() throws Exception {
        ...
        types.put("TransferWithAuthorization",
                Arrays.asList(Map.of("name", "from", "type", "address"), Map.of("name", "to", "type", "address"),
        ...
        String sig = X402_OKX_Custom.signTypedData(privateKey, domain, types, message, "TransferWithAuthorization");
        ...
        String paymentSignature = X402_OKX_Custom.buildX402Header(x402Version, signResult, resource, accepted);
