...
public class YgmeStakingDomain extends Contract {
    ...
    @Deprecated
    protected YgmeStakingDomain(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
            BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected YgmeStakingDomain(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected YgmeStakingDomain(String contractAddress, Web3j web3j, TransactionManager transactionManager,
    ...
    @Deprecated
    public static YgmeStakingDomain load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new YgmeStakingDomain(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static YgmeStakingDomain load(String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<YgmeStakingDomain> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(YgmeStakingDomain.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<YgmeStakingDomain> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice,
            BigInteger gasLimit) {
        return deployRemoteCall(YgmeStakingDomain.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<YgmeStakingDomain> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
