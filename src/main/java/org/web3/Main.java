...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Multicall2Test contract1 = Multicall2Test.load(multicallAddressOwner, web3j,
                new RawTransactionManager(web3j, credentials), contractGasProvider);
        ...
        try {
            ...
            IERC165 erc165 = IERC165.load(ERC6551Account, web3j, new ReadonlyTransactionManager(web3j, null),
                    contractGasProvider);
    ...
    public static void getTokenURI(Web3j web3j, String multicalladdress, String tokenAddress, String[] tokenIds) {
        Map<String, String> mapsTokenURI = null;

        try {
            mapsTokenURI = NFTTokenURI.getTokenURI(web3j, multicalladdress, tokenAddress, tokenIds);
        } catch (Exception e) {
    ...
    public static void getTokenURI(Web3j web3j, Credentials credentials, String multicalladdress, String tokenAddress,
            String[] tokenIds) {
        Map<String, String> mapsTokenURI1 = null;
        try {
            mapsTokenURI1 = NFTTokenURIOP.getTokenURI(web3j, credentials, multicalladdress, tokenAddress, tokenIds);
        } catch (Exception e) {
            throw new RuntimeException(e);
    ...
    public static void changeData(Web3j web3j, Credentials credentials, String contractAddress) throws Exception {
        ContractGasProvider contractGasProvider = new DefaultGasProvider();
