...
public class ListenNFTExchangeEvent {
    ...
    public static void main(String[] args) {
        ...
        contract.exchangeEventFlowable(startBlock, endBlock).subscribe(event -> {
            ...
            System.out.println("sellToken:" + event.sellToken + " sellTokenId:" + event.sellTokenId + " sellAmount:"
                    + event.sellAmount + " unitPrice:" + event.unitPrice + " seller:" + event.seller + " buyToken:"
                    + event.buyToken + " buyTokenId:" + event.buyTokenId + " buyer:" + event.buyer + " amount:"
                    + event.amount + " payPrice:" + event.payPrice + " royaltyFee:" + event.royaltyFee);
